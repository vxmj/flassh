    ...
    <div className="h-screen flex flex-col relative overflow-hidden" style={bgStyle}>
      ...
      <header className="flex items-center justify-between px-2 md:px-4 py-2 mx-1 md:mx-2 mt-1 md:mt-2 rounded-xl backdrop-blur-md shrink-0 relative z-[50] bg-surface border border-border">
        ...
        <div className="flex items-center gap-1 md:gap-2 flex-shrink-0">
          <a href="https://t.me/+cbOi66BOhcNhYzg1" target="_blank" rel="noopener noreferrer" className="hidden sm:flex items-center gap-1 px-2 py-1 rounded-lg text-xs bg-surface text-text-secondary border border-border hover:text-primary hover:border-primary/50 transition-all" title="加入 Telegram 群组反馈 Bug">
